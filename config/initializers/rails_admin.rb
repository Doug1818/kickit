# RailsAdmin config file. Generated on June 26, 2013 17:14
...
RailsAdmin.config do |config|
  ...
  # config.excluded_models = ['Day', 'Remessage', 'Reminder', 'SentText', 'User']

  # Include specific models (exclude the others):
  # config.included_models = ['Day', 'Remessage', 'Reminder', 'SentText', 'User']
